...
public class MaterialsharingFragment extends Fragment {
    private ImageButton supply1,supply2,ima_back_share,ima_left,ima_right;
    private ImageButton Btn_buy1,Btn_buy2;
    private TextView goods_name,goods_money;
    private EditText edit_number;

    private SharingFragment interaction;

    public MaterialsharingFragment() {
    ...
    private void ButtonController(){
        ...
        goods_name.setText("商品名稱: "+"狗碗");
        goods_money.setText("商品價格: "+"20元");
    ...
    private void ButtonController2(){
        ...
        goods_name.setText("商品名稱: "+"鼠籠");
        goods_money.setText("商品價格: "+"200元");
    }
    ...
    private void processViews(View view){
        supply1 = (ImageButton) view.findViewById(R.id.supply1);
        supply2 = (ImageButton) view.findViewById(R.id.supply2);
        ...
        Btn_buy1 = (ImageButton) view.findViewById(R.id.Btn_buy1);
        Btn_buy2 = (ImageButton) view.findViewById(R.id.Btm_buy2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_materialsharing, container, false);
        processViews(view);
        processController();
        Touch();
        right_left();
    ...
    public void onAttach(Context context) {
        ...
        try{
            interaction = (SharingFragment) context;
        }catch (Exception err){
            err.printStackTrace();
        }
    }
    ...
    public interface SharingFragment{
